...
<body style="background-color: #121212;">
	...
	<div class="container-fluid d-flex justify-content-center">
		<div class="login-form">
			...
			<form action="${pageContext.request.contextPath}/record/create"
				method="post" modelAttribute="record">
				<div class="row my-4">
					<div class="col-md-6" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							<select name="customers" path="customerId"
					...
					<div class="col-md-6" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							<select name="computers" path="computerId"
								class="form-control input text-white"
								style="background: #2b2b2b; border: none">
				...
				<div class="row my-4">
					...
					<div class="col-md-4" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							<input class="form-control input text-white"
					...
					<div class="col-md-4 " style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							<input class="form-control input text-white" id="usingTime"
