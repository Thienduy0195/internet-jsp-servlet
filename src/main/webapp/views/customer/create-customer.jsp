				...
				<div class="row my-4">
					<div class="col-md-3" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							...
							<span class="text-danger">${error.get("customerId")}</span>
						</div>
					</div>
					<div class="col-md-6" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							...
							<span class="text-danger">${error.get("name")}</span>
						</div>
					</div>
					...
					<div class="col-md-3" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							...
							<span class="text-danger">${error.get("phoneNumber")}</span>
						</div>
					</div>
				...
				<div class="row my-4">
					<div class="col-md-6" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							...
							<span class="text-danger">${error.get("email")}</span>
						</div>
					</div>
					...
					<div class="col-md-6" style="padding-right: 15px">
						<div class="form-floating textbox mb-4">
							...
							<span class="text-danger">${error.get("address")}</span>
						</div>
					</div>
				</div>
